...

{
  ...
  cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ZL","TTL","VVL","STL","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"},sig_procs})).AddSyst(cb,"CMS_eff_e_2016","lnN",SystMap<>::init(1.02));

  // Against ele and against mu for real taus
  //cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"},sig_procs})).AddSyst(cb,"CMS_eff_t_againstemu_et_2016","lnN",SystMap<>::init(1.03));
  ...
  cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ZL","TTL","VVL","STL","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"},sig_procs})).AddSyst(cb,"CMS_singleeletrg_2016","lnN",SystMap<>::init(1.02));
  ...
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}})).AddSyst(cb, "lumi_13TeV_2016", "lnN", SystMap<>::init(1.010));
cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}})).AddSyst(cb, "lumi_13TeV_correlated", "lnN", SystMap<>::init(1.006));
  ...
  if(not Input.OptionExists("-s"))
      ...
      else
	{
	  ...
	  AddShapesIfNotEmpty({"CMS_scale_efaket_1prong_barrel_2016",
        ...
        AddShapesIfNotEmpty({"CMS_efaket_norm_pt30to50_2016","CMS_efaket_norm_pt50to70_2016","CMS_efaket_norm_ptgt70_2016","CMS_etauFR_barrel_2016","CMS_etauFR_endcap_2016"},
        {"ZL","STL","TTL","VVL"},
        &cb,
        1.00,
        TheFile,CategoryArgs);
	...
	{
	  AddShapesIfNotEmpty({
	      "CMS_rawFF_et_qcd_0jet_barrel_unc1_2016",
		"CMS_rawFF_et_qcd_0jet_barrel_unc2_2016",
		"CMS_rawFF_et_w_0jet_barrel_unc1_2016",
		"CMS_rawFF_et_w_0jet_barrel_unc2_2016",
		"CMS_rawFF_et_qcd_1jet_barrel_unc1_2016",
		"CMS_rawFF_et_qcd_1jet_barrel_unc2_2016",
		"CMS_rawFF_et_w_1jet_barrel_unc1_2016",
		"CMS_rawFF_et_w_1jet_barrel_unc2_2016",
		"CMS_rawFF_et_qcd_2jet_barrel_unc1_2016",
		"CMS_rawFF_et_qcd_2jet_barrel_unc2_2016",
		"CMS_rawFF_et_w_2jet_barrel_unc1_2016",
		"CMS_rawFF_et_w_2jet_barrel_unc2_2016",

		"CMS_rawFF_et_qcd_0jet_endcap_unc1_2016",
		"CMS_rawFF_et_qcd_0jet_endcap_unc2_2016",
		"CMS_rawFF_et_w_0jet_endcap_unc1_2016",
		"CMS_rawFF_et_w_0jet_endcap_unc2_2016",
		"CMS_rawFF_et_qcd_1jet_endcap_unc1_2016",
		"CMS_rawFF_et_qcd_1jet_endcap_unc2_2016",
		"CMS_rawFF_et_w_1jet_endcap_unc1_2016",
		"CMS_rawFF_et_w_1jet_endcap_unc2_2016",
		"CMS_rawFF_et_qcd_2jet_endcap_unc1_2016",
		"CMS_rawFF_et_qcd_2jet_endcap_unc2_2016",
		"CMS_rawFF_et_w_2jet_endcap_unc1_2016",
		"CMS_rawFF_et_w_2jet_endcap_unc2_2016",
		...
		"CMS_FF_norm_et_3jet_2016",
		"CMS_FF_norm_et_4jet_2016",
		},
	    {"jetFakes"},
	    &cb,
	    1.00,
      ...
      if(Input.OptionExists("-dm")||Input.OptionExists("-dn")||Input.OptionExists("-dp")||Input.OptionExists("-dljpt"))
	{
	  AddShapesIfNotEmpty({"CMS_scale_t_1prong_2016","CMS_scale_t_3prong_2016","CMS_scale_t_1prong1pizero_2016","CMS_scale_t_3prong1pizero_2016"},
			      JoinStr({sig_procs,{"STT","VVT","ZT","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}}),
			      &cb,
			      1.00,
			      TheFile,CategoryArgs);
	}
      else
	{
	  ...
	  AddShapesIfNotEmpty({"CMS_scale_t_1prong_2016","CMS_scale_t_3prong_2016","CMS_scale_t_1prong1pizero_2016","CMS_scale_t_3prong1pizero_2016"},
			      JoinStr({sig_procs,{"TTT","OutsideAcceptance"}}),
			      &cb,
			      1.00,
      ...
      else
	{
	  ...
	  AddShapesIfNotEmpty({"CMS_res_j_2016"},
			      JoinStr({sig_procs,{"ZT","TTT","OutsideAcceptance"}}),
			      &cb,
			      1.000,
			      TheFile,{"et_vbflow","et_vbfhigh"});
	}
