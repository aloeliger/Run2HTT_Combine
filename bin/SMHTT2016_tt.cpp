...
int main(int argc, char **argv) 
{
  ...
  cb.cp().process({"jetFakes"}).bin({"htt_PTH_tt_HighTauPt","htt_NJ_tt_HighTauPt","htt_J1PT_tt_HighTauPt"}).AddSyst(cb,"CMS_jetFakesNorm_HighTauPt_tt_2016","lnN",SystMap<>::init(1.05));
