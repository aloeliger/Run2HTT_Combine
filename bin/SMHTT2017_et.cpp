...
int main(int argc, char **argv) 
{
  ...
  else if (Input.OptionExists("-dp") or Input.OptionExists("-dn") or Input.OptionExists("-dm")||Input.OptionExists("-dljpt")) TheFile = new TFile((aux_shapes+"smh2017et_Differential.root").c_str());
  ...
  //Ele ID efficiency 
  cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ZL","TTL","VVL","STL"},ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,sig_procs})).AddSyst(cb,"CMS_eff_e_2017","lnN",SystMap<>::init(1.02));

  // Against ele and against mu for real taus
  cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT"},ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,sig_procs})).AddSyst(cb,"CMS_eff_t_againstemu_et_2017","lnN",SystMap<>::init(1.03));
  ...
  cb.cp().process(JoinStr({{"W","ZT","VVT","ZL","VVL"},ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,sig_procs})).AddSyst(cb,"CMS_btag_lfstats1_2017","lnN",SystMap<>::init(0.999));

  cb.cp().process({"STT","STL","TTT","TTL"}).AddSyst(cb,"CMS_btag_lfstats2_2017","lnN",SystMap<>::init(0.995));
  cb.cp().process(JoinStr({{"W","ZT","VVT","ZL","VVL"},ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,sig_procs})).AddSyst(cb,"CMS_btag_lfstats2_2017","lnN",SystMap<>::init(1.001));
  ...
  if(not (Input.OptionExists("-x1")))
    {
      cb.cp().process({"ggH_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.002,0.998));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_10_200_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.006,0.997));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_0_10_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.000,0.998));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_0_60_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.954,1.026));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_60_120_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.069,0.956));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_120_200_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_0_60_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_60_120_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_120_200_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_200_300_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_300_450_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_450_650_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_GE650_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.027,0.986));
      cb.cp().process({"qqH_0J_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.022,0.991));
      cb.cp().process({"qqH_1J_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.041,0.974));
      cb.cp().process({"qqH_GE2J_MJJ_0_60_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_60_120_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_120_350_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_GE200_htt"}).bin({"et_0jet"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"ggH_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.971,1.024));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_10_200_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.983,1.004));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_0_10_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_0_60_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.952,1.037));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_60_120_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.980,1.025));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_120_200_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.952,1.036));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_0_60_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.122,0.929));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_60_120_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.026,0.977));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_120_200_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.043,0.957));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_200_300_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.925,1.075));
      cb.cp().process({"ggH_PTH_300_450_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.920,1.087));
      cb.cp().process({"ggH_PTH_450_650_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.084,0.955));
      cb.cp().process({"ggH_PTH_GE650_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.011,0.994));
      cb.cp().process({"qqH_0J_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.980,1.011));
      cb.cp().process({"qqH_1J_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.011,0.995));
      cb.cp().process({"qqH_GE2J_MJJ_0_60_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.909,1.012));
      cb.cp().process({"qqH_GE2J_MJJ_60_120_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.000,0.952));
      cb.cp().process({"qqH_GE2J_MJJ_120_350_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.009,0.986));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.169,0.926));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.120,0.934));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_GE200_htt"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"ggH_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.017,0.977));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_10_200_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_0_10_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.038,0.984));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_0_60_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.013,0.996));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_60_120_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.033,0.979));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_120_200_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.041,0.955));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_0_60_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.980,0.983));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_60_120_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.012,0.979));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_120_200_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.027,0.972));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.082,0.907));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.047,0.909));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_200_300_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.038,0.975));
      cb.cp().process({"ggH_PTH_300_450_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.978,1.001));
      cb.cp().process({"ggH_PTH_450_650_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.054,0.941));
      cb.cp().process({"ggH_PTH_GE650_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.985,1.013));
      cb.cp().process({"qqH_0J_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_1J_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.053,0.964));
      cb.cp().process({"qqH_GE2J_MJJ_0_60_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_60_120_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.943,1.033));
      cb.cp().process({"qqH_GE2J_MJJ_120_350_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.969,1.020));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.898,1.081));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.031,0.997));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_GE200_htt"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"ggH_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.061,0.957));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_10_200_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_0_10_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_0_60_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_60_120_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.037,0.973));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_120_200_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.023,0.977));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_0_60_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_60_120_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_120_200_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.205,0.885));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.039,0.974));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.088,0.924));
      cb.cp().process({"ggH_PTH_200_300_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.073,0.944));
      cb.cp().process({"ggH_PTH_300_450_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_450_650_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_GE650_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.986,1.009));
      cb.cp().process({"qqH_0J_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_1J_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.026,0.995));
      cb.cp().process({"qqH_GE2J_MJJ_0_60_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_60_120_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_120_350_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.957,1.031));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.960,1.023));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.976,1.004));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.984,1.010));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.009,0.994));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_GE200_htt"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.004,0.994));
      cb.cp().process({"ggH_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.099,0.961));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_10_200_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.006,0.997));
      cb.cp().process({"ggH_PTH_0_200_0J_PTH_0_10_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_0_60_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_60_120_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_1J_PTH_120_200_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_0_60_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_60_120_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_0_350_PTH_120_200_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_0_200_GE2J_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"ggH_PTH_200_300_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.099,0.961));
      cb.cp().process({"ggH_PTH_300_450_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.081,0.972));
      cb.cp().process({"ggH_PTH_450_650_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.177,0.911));
      cb.cp().process({"ggH_PTH_GE650_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.00));
      cb.cp().process({"qqH_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.978,1.008));
      cb.cp().process({"qqH_0J_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_1J_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_0_60_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_60_120_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_120_350_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_0_25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_350_700_PTHJJ_GE25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_0_25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(1.038,0.980));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_0_200_MJJ_GE700_PTHJJ_GE25_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",SystMap<>::init(1.0));
      cb.cp().process({"qqH_GE2J_MJJ_GE350_PTH_GE200_htt"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_pythia_scale","lnN",ch::syst::SystMapAsymm<>::init(0.980,1.005));
    }
  ...
  cb.cp().process({qqH_STXS}).bin({"et_0jet"}).AddSyst(cb,"pdf_Higgs_qqbar_ACCEPT","lnN",SystMap<>::init(1.015));
  cb.cp().process({qqH_STXS}).bin({"et_boosted1"}).AddSyst(cb,"pdf_Higgs_qqbar_ACCEPT","lnN",SystMap<>::init(1.003));
  cb.cp().process({qqH_STXS}).bin({"et_boosted2"}).AddSyst(cb,"pdf_Higgs_qqbar_ACCEPT","lnN",SystMap<>::init(1.004));
  cb.cp().process({qqH_STXS}).bin({"et_vbflow"}).AddSyst(cb,"pdf_Higgs_qqbar_ACCEPT","lnN",SystMap<>::init(1.013));
  cb.cp().process({qqH_STXS}).bin({"et_vbfhigh"}).AddSyst(cb,"pdf_Higgs_qqbar_ACCEPT","lnN",SystMap<>::init(1.013));

  //Luminosity Uncertainty
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_2017", "lnN", SystMap<>::init(1.020));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_XY", "lnN", SystMap<>::init(1.008));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_LS", "lnN", SystMap<>::init(1.003));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_BBD", "lnN", SystMap<>::init(1.004));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_DB", "lnN", SystMap<>::init(1.005));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_BCC", "lnN", SystMap<>::init(1.003));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","ggH_htt_nonfid125","qqH_htt_nonfid125","WH_htt_nonfid125","ZH_htt_nonfid125"}})).AddSyst(cb, "lumi_13TeV_GS", "lnN", SystMap<>::init(1.001));
  ...
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(0.985));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(0.96));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(1.03));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(0.98));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(1.07));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(1.01));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(1.1));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(1.08));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(0.98));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_res_j_2017","lnN",SystMap<>::init(0.99));
  ...
  //*** scale_j_Absolute_2017 ***
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(0.995));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(0.98));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.01));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.01));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.03));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_Absolute_2017","lnN",SystMap<>::init(1.0));
  ...
  //*** scale_j_BBEC1_2017 ***
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(0.98));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(0.995));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.01));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(0.98));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.02));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(0.985));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_BBEC1_2017","lnN",SystMap<>::init(1.0));
  ...
  //*** scale_j_HF_2017 ***
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.01));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(0.995));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(0.98));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_HF_2017","lnN",SystMap<>::init(1.0));

  //*** scale_j_RelativeSample_2017 ***
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.01));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.0));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(0.98));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.0));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.01));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.015));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(0.985));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_RelativeSample_2017","lnN",SystMap<>::init(1.005));
  ...
  //*** scale_j_EC2_2017 ***
  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(0.995));
  cb.cp().process({"TTT","TTL"}).bin({"et_0jet"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(0.985));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(1.005));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted1"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(0.985));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(1.005));
  cb.cp().process({"TTT","TTL"}).bin({"et_boosted2"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(1.02));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(0.99));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbflow"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(1.03));

  cb.cp().process({"VVT","VVL","ZL","STT","STL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(0.97));
  cb.cp().process({"TTT","TTL"}).bin({"et_vbfhigh"}).AddSyst(cb,"CMS_scale_j_EC2_2017","lnN",SystMap<>::init(1.0));
  ...
  if(not Input.OptionExists("-s"))
    {
      ...
      AddShapesIfNotEmpty({"CMS_prefiring"},
                          JoinStr({sig_procs,ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,{"VVL","VVT","STT","STL","ZL","ZT","TTL","TTT"}}),
                          &cb,
                          1.00,
      ...
      AddShapesIfNotEmpty({"CMS_tauideff_pt30to35_2017","CMS_tauideff_pt35to40_2017","CMS_tauideff_ptgt40_2017"},
                          JoinStr({sig_procs,ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,{"VVT","STT","ZT","TTT"}}),
                          &cb,
                          1.00,
                          TheFile,CategoryArgs);
      ...
      AddShapesIfNotEmpty({"CMS_singleeletrg_2017","CMS_eletautrg_2017"},
                          JoinStr({sig_procs,ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,{"VVT","STT","ZT","TTT","VVL","STL","TTL","ZL"}}),
                          &cb,
                          1.00,
                          TheFile,CategoryArgs);
      ...
      if(Input.OptionExists("-c"))
	{
	  AddShapesIfNotEmpty({"CMS_htt_boson_reso_met_0jet_2017","CMS_htt_boson_scale_met_0jet_2017",
	    ...
	    JoinStr({ggH_STXS,qqH_STXS,ggH_HWW_STXS,qqH_HWW_STXS,{"ZT","ZL"}}),
	    &cb,
	    1.00,
	    TheFile,CategoryArgs);
	}
	...
	{
	  AddShapesIfNotEmpty({"CMS_htt_boson_reso_met_0jet_2017","CMS_htt_boson_scale_met_0jet_2017"},
			      JoinStr({ggH_STXS,qqH_STXS,ggH_HWW_STXS,qqH_HWW_STXS,{"ZT","ZL","ggH_hww125","qqH_hww125"}}),
			      &cb,
			      1.00,
			      TheFile,
			      {"et_0jet"});
	...
	TheFile,CategoryArgs);
      */
      AddShapesIfNotEmpty({"CMS_scale_j_Absolute","CMS_scale_j_Absolute_2017","CMS_scale_j_BBEC1","CMS_scale_j_BBEC1_2017","CMS_scale_j_EC2","CMS_scale_j_EC2_2017",
	    "CMS_scale_j_FlavorQCD","CMS_scale_j_HF","CMS_scale_j_HF_2017","CMS_scale_j_RelativeSample_2017","CMS_scale_j_RelativeBal"},
	JoinStr({sig_procs,ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS}),
	&cb,
	1.000,
	TheFile,CategoryArgs);
      ...
      else if(not(Input.OptionExists("-x0")||Input.OptionExists("-x1")))
	{
      ...
      AddShapesIfNotEmpty({"CMS_scale_e"},
			  JoinStr({sig_procs,ggH_HWW_STXS,qqH_HWW_STXS,WH_HWW_STXS,ZH_HWW_STXS,ggZH_HWW_STXS,{"ZT","VVT","STT","TTT","ZL","VVL","STL","TTL"}}),
	&cb,
	1.00,
	TheFile,CategoryArgs);
