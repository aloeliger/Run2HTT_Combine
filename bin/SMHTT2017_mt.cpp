...
//pdf acceptance uncertainties
  ...
  //Muon ID efficiency
  cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ZL","TTL","VVL","STL","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"},sig_procs})).AddSyst(cb,"CMS_eff_m_2017","lnN",SystMap<>::init(1.02));

  // Against ele and against mu for real taus
  //cb.cp().process(JoinStr({{"ZT","TTT","VVT","STT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"},sig_procs})).AddSyst(cb,"CMS_eff_t_againstemu_mt_2017","lnN",SystMap<>::init(1.01));
  ...
  cb.cp().process({"jetFakes"}).bin({"htt_PTH_mt_HighTauPt","htt_NJ_mt_HighTauPt","htt_J1PT_mt_HighTauPt"}).AddSyst(cb,"CMS_jetFakesNorm_HighTauPt_mt_2017","lnN",SystMap<>::init(1.10));
  ...
  if(not Input.OptionExists("-s"))
	...
	{
	  AddShapesIfNotEmpty({
	      "CMS_rawFF_mt_qcd_0jet_barrel_unc1_2017",
		"CMS_rawFF_mt_qcd_0jet_barrel_unc2_2017",
		"CMS_rawFF_mt_w_0jet_barrel_unc1_2017",
		"CMS_rawFF_mt_w_0jet_barrel_unc2_2017",
		"CMS_rawFF_mt_qcd_1jet_barrel_unc1_2017",
		"CMS_rawFF_mt_qcd_1jet_barrel_unc2_2017",
		"CMS_rawFF_mt_w_1jet_barrel_unc1_2017",
		"CMS_rawFF_mt_w_1jet_barrel_unc2_2017",
		"CMS_rawFF_mt_qcd_2jet_barrel_unc1_2017",
		"CMS_rawFF_mt_qcd_2jet_barrel_unc2_2017",
		"CMS_rawFF_mt_w_2jet_barrel_unc1_2017",
		"CMS_rawFF_mt_w_2jet_barrel_unc2_2017",

		"CMS_rawFF_mt_qcd_0jet_endcap_unc1_2017",
		"CMS_rawFF_mt_qcd_0jet_endcap_unc2_2017",
		"CMS_rawFF_mt_w_0jet_endcap_unc1_2017",
		"CMS_rawFF_mt_w_0jet_endcap_unc2_2017",
		"CMS_rawFF_mt_qcd_1jet_endcap_unc1_2017",
		"CMS_rawFF_mt_qcd_1jet_endcap_unc2_2017",
		"CMS_rawFF_mt_w_1jet_endcap_unc1_2017",
		"CMS_rawFF_mt_w_1jet_endcap_unc2_2017",
		"CMS_rawFF_mt_qcd_2jet_endcap_unc1_2017",
		"CMS_rawFF_mt_qcd_2jet_endcap_unc2_2017",
		"CMS_rawFF_mt_w_2jet_endcap_unc1_2017",
		"CMS_rawFF_mt_w_2jet_endcap_unc2_2017",
		...
		"CMS_FF_closure_ljpt_pth120to200_mt_w",
		"CMS_FF_closure_ljpt_pthgt200_mt_w",

		"CMS_FF_norm_mt_0jet_2017",
		"CMS_FF_norm_mt_1jet_2017",
		"CMS_FF_norm_mt_2jet_2017",
		"CMS_FF_norm_mt_3jet_2017",
		"CMS_FF_norm_mt_4jet_2017",
		},
	    {"jetFakes"},
	    &cb,
	    1.00,
