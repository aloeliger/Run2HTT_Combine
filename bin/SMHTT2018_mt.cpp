...
//pdf acceptance uncertainties
  ...
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZT","ZL","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}})).AddSyst(cb, "lumi_13TeV_XY", "lnN", SystMap<>::init(1.020));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZT","ZL","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}})).AddSyst(cb, "lumi_13TeV_LS", "lnN", SystMap<>::init(1.002));
  cb.cp().process(JoinStr({sig_procs,{"VVL","VVT","STT","STL","ZT","ZL","TTL","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}})).AddSyst(cb, "lumi_13TeV_BCC", "lnN", SystMap<>::init(1.002));
  ...
  if(not Input.OptionExists("-s"))
	...
	{	  
	  ...
	  JESVector = JoinStr({ggH_STXS,qqH_STXS,{"ZT","VVT","STT","TTT","WH_htt125","ZH_htt125","VVL","STL","ZL","TTL","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125"}});
          RESVector = JoinStr({ggH_STXS,qqH_STXS,{"VVT","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125"}});
	...
	{	  
	  ...
	  JESVector = JoinStr({ggH_STXS,qqH_STXS,{"VVT","STT","TTT","WH_htt125","ZH_htt125","VVL","ZL","TTL","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}});
          RESVector = JoinStr({ggH_STXS,qqH_STXS,{"VVT","TTT","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}});
	  MuESVector = JoinStr({ggH_STXS,qqH_STXS,{"ZL","VVT","STT","TTT","VVL","STL","TTL","WH_htt125","ZH_htt125","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}});
	  TauIDVector = JoinStr({ggH_STXS,qqH_STXS,{"VVT","STT","TTT","WH_htt125","ZH_htt125","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}});
	  TriggerVector = JoinStr({ggH_STXS,qqH_STXS,{"VVT","STT","TTT","VVL","STL","TTL","ZL","WH_htt125","ZH_htt125","ggH_hww125","qqH_hww125","WH_hww125","ZH_hww125","OutsideAcceptance"}});
	}
      ...
      if(Input.OptionExists("-dp")||Input.OptionExists("-dn")||Input.OptionExists("-dm")||Input.OptionExists("-dljpt"))
	{
	  AddShapesIfNotEmpty({"CMS_m_FakeTau_etalt0p4_2018","CMS_m_FakeTau_eta0p4to0p8_2018",
		...
		"CMS_m_FakeTau_etagt1p7_2018","CMS_m_FakeTau_taupt30to50_2018",
		"CMS_m_FakeTau_taupt50to70_2018","CMS_m_FakeTau_tauptgt70_2018"},
	    {"ZL"},
	    &cb,
	    1.00,
    ...
    {
      AddShapesIfNotEmpty({
	      "CMS_rawFF_mt_qcd_0jet_barrel_unc1_2018",
		"CMS_rawFF_mt_qcd_0jet_barrel_unc2_2018",
		"CMS_rawFF_mt_w_0jet_barrel_unc1_2018",
		"CMS_rawFF_mt_w_0jet_barrel_unc2_2018",
		"CMS_rawFF_mt_qcd_1jet_barrel_unc1_2018",
		"CMS_rawFF_mt_qcd_1jet_barrel_unc2_2018",
		"CMS_rawFF_mt_w_1jet_barrel_unc1_2018",
		"CMS_rawFF_mt_w_1jet_barrel_unc2_2018",
		"CMS_rawFF_mt_qcd_2jet_barrel_unc1_2018",
		"CMS_rawFF_mt_qcd_2jet_barrel_unc2_2018",
		"CMS_rawFF_mt_w_2jet_barrel_unc1_2018",
		"CMS_rawFF_mt_w_2jet_barrel_unc2_2018",

		"CMS_rawFF_mt_qcd_0jet_endcap_unc1_2018",
		"CMS_rawFF_mt_qcd_0jet_endcap_unc2_2018",
		"CMS_rawFF_mt_w_0jet_endcap_unc1_2018",
		"CMS_rawFF_mt_w_0jet_endcap_unc2_2018",
		"CMS_rawFF_mt_qcd_1jet_endcap_unc1_2018",
		"CMS_rawFF_mt_qcd_1jet_endcap_unc2_2018",
		"CMS_rawFF_mt_w_1jet_endcap_unc1_2018",
		"CMS_rawFF_mt_w_1jet_endcap_unc2_2018",
		"CMS_rawFF_mt_qcd_2jet_endcap_unc1_2018",
		"CMS_rawFF_mt_qcd_2jet_endcap_unc2_2018",
		"CMS_rawFF_mt_w_2jet_endcap_unc1_2018",
		"CMS_rawFF_mt_w_2jet_endcap_unc2_2018",
		...
		"CMS_FF_norm_mt_2jet_2018",
		"CMS_FF_norm_mt_3jet_2018",
		"CMS_FF_norm_mt_4jet_2018",
		},
	    {"jetFakes"},
	    &cb,
	    1.00,
      ...
      else if (Input.OptionExists("-dp")||Input.OptionExists("-dn")||Input.OptionExists("-dm")||Input.OptionExists("-dljpt"))
	{
	  ...
	  AddShapesIfNotEmpty({"THU_ggH_Mu","THU_ggH_Res","THU_ggH_Mig01","THU_ggH_Mig12","THU_ggH_VBF2j",
	    ...
	    JoinStr({ggH_STXS,{"ggH_hww125","ggH_htt_nonfid125","OutsideAcceptance"}}),
	    &cb,
	    1.00,
	    TheFile,CategoryArgs);            
	}
