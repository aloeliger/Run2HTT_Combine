...
int main(int argc, char **argv) {
  ...
  string theFileName = "whmtt2016.root";
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"wh"}, {"2016"}, {"mtt"}, cats);
  ...
  cb.AddProcesses({"*"}, {"wh"}, {"2016"}, {"mtt"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"wh"}, {"2016"}, {"mtt"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_singlemutrg_2016", "lnN", SystMap<>::init(1.02));
  ...
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_1prong1pizero_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_3prong_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_3prong1pizero_2016", "shape", SystMap<>::init(1.00));

  // Tau ID
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_tauideff_pt20to25_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_tauideff_pt25to30_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_tauideff_pt30to35_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_tauideff_pt35to40_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_tauideff_ptgt40_2016", "shape", SystMap<>::init(1.00));

  //Scale met
  theShapeDebugger.cp().process(JoinStr({{"WZ","ZZ"},sig_procs})).AddSyst(cb,"CMS_scale_met_unclustered_2016", "shape", SystMap<>::init(1.00));

  //Scale m
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_etalt1p2_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_eta1p2to2p1_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_etagt2p1_2016", "shape", SystMap<>::init(1.00));

  //Prefiring
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_prefiring", "shape", SystMap<>::init(1.00));


  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt20to25_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt25to30_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt30to35_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt35to40_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt40to50_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt50to60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_ptgt60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt20to25_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt25to30_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt30to35_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt35to40_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt40to50_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt50to60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_ptgt60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt20to25_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt25to30_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt30to35_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt35to40_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt40to50_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt50to60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_ptgt60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt20to25_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt25to30_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt30to35_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt35to40_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt40to50_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt50to60_2016", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_ptgt60_2016", "shape", SystMap<>::init(1.00));

  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "whmtt2016.root",
      "$BIN/$PROCESS",
...
*/
  ...
  TFile output((Input.ReturnToken(0)+"/"+"wh2016_mtt.input.root").c_str(), "RECREATE");
