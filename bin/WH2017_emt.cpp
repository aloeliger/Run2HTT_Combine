...
int main(int argc, char **argv) {
  ...
  string theFileName = "whemt2017.root";
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"wh"}, {"2017"}, {"emt"}, cats);
  ...
  cb.AddProcesses({"*"}, {"wh"}, {"2017"}, {"emt"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"wh"}, {"2017"}, {"emt"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_singleeletrg_2017", "lnN", SystMap<>::init(1.01));
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_singlemutrg_2017", "lnN", SystMap<>::init(1.01));
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_eff_e_2017", "lnN", SystMap<>::init(1.02));
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_eff_m_2017", "lnN", SystMap<>::init(1.02));

  // Against ele and against mu for real taus
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_eff_t_againstemu_emt_2017","lnN",SystMap<>::init(1.03));
  ...
  // TES
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_1prong_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_1prong1pizero_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_3prong_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_t_3prong1pizero_2017", "shape", SystMap<>::init(1.00));
  ...
  //Scale mu, ele
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_e_2017", "shape", SystMap<>::init(1.00));
  ...
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_pt10to15_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_pt15to20_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_pt20to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_pt30to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_ptgt40_2017", "shape", SystMap<>::init(1.00));
  ...
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_ptgt60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_ptgt60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_ptgt60_2017", "shape", SystMap<>::init(1.00));

  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeEle_promptSubtraction_2017", "shape", SystMap<>::init(1.00));
...
*/
  ...
  TFile output((Input.ReturnToken(0)+"/"+"wh2017_emt.input.root").c_str(), "RECREATE");
