...
int main(int argc, char **argv) {
  ...
  string theFileName = "whett2017.root";
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"wh"}, {"2017"}, {"ett"}, cats);
  ...
  cb.AddProcesses({"*"}, {"wh"}, {"2017"}, {"ett"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"wh"}, {"2017"}, {"ett"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_singleeletrg_2017", "lnN", SystMap<>::init(1.02));
  ...
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_eff_t_againstemu_et_2017","lnN",SystMap<>::init(1.03));
  ...
  //Scale e
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_e_2017", "shape", SystMap<>::init(1.00));

  //Prefiring
  theShapeDebugger.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_prefiring", "shape", SystMap<>::init(1.00));

  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_ptgt60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_ptgt60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_ptgt60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt40to50_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt50to60_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_ptgt60_2017", "shape", SystMap<>::init(1.00));

  theShapeDebugger.report();

  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "whett2017.root",
      "$BIN/$PROCESS",
...
*/
  ...
  TFile output((Input.ReturnToken(0)+"/"+"wh2017_ett.input.root").c_str(), "RECREATE");
