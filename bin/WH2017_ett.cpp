...
int main(int argc, char **argv) {
  ...
  //Scale e
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_scale_e_2017", "shape", SystMap<>::init(1.00));

  //Prefiring
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb,"CMS_prefiring", "shape", SystMap<>::init(1.00));

  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm0_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm1_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm10_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_Te_dm11_ptgt60_2017", "shape", SystMap<>::init(1.00));
