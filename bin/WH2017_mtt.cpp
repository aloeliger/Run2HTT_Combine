...
int main(int argc, char **argv) {
  ...
  string theFileName = "whmtt2017.root";
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"wh"}, {"2017"}, {"mtt"}, cats);
  ...
  cb.AddProcesses({"*"}, {"wh"}, {"2017"}, {"mtt"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"wh"}, {"2017"}, {"mtt"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_ptgt60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt20to25_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt25to30_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt30to35_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt35to40_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt40to50_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt50to60_2017", "shape", SystMap<>::init(1.00));
  cb.cp().process({"jetFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_ptgt60_2017", "shape", SystMap<>::init(1.00));

  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "whmtt2017.root",
      "$BIN/$PROCESS",
...
*/
  ...
  TFile output((Input.ReturnToken(0)+"/"+"wh2017_mtt.input.root").c_str(), "RECREATE");
