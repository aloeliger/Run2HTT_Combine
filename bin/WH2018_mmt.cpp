...
int main(int argc, char **argv) {
  ...
  string theFileName = "whmmt2018.root";
  ...
  // Eff ID, trigger
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_singlemutrg_2018", "lnN", SystMap<>::init(1.02));
  cb.cp().process(JoinStr({{"TriBoson","WZ","ZZ","TTV"},sig_procs,HWW})).AddSyst(cb, "CMS_eff_m_2018", "lnN", SystMap<>::init(1.04));
  ...
  //Scale mu
  theShapeDebugger.cp().process(JoinStr({{"allFakes","TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_etalt1p2_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"allFakes","TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_eta1p2to2p1_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"allFakes","TriBoson","WZ","ZZ","TTV"},sig_procs})).AddSyst(cb,"CMS_scale_m_etagt2p1_2018", "shape", SystMap<>::init(1.00));
  ...
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt20to25_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt25to30_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt30to35_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt35to40_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt40to50_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_pt50to60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm0_ptgt60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt20to25_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt25to30_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt30to35_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt35to40_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt40to50_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_pt50to60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm1_ptgt60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt20to25_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt25to30_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt30to35_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt35to40_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt40to50_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_pt50to60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm10_ptgt60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt20to25_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt25to30_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt30to35_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt35to40_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt40to50_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_pt50to60_2018", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"allFakes"}).AddSyst(cb,"CMS_fakeTauVT_dm11_ptgt60_2018", "shape", SystMap<>::init(1.00));
