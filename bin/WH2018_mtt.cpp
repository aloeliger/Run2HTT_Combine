...
int main(int argc, char **argv) {
  ...
  string theFileName = "whmtt2018.root";
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"wh"}, {"2018"}, {"mtt"}, cats);
  ...
  cb.AddProcesses({"*"}, {"wh"}, {"2018"}, {"mtt"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"wh"}, {"2018"}, {"mtt"}, sig_procs, cats, true);
  //! [part4]
...
*/
  ...
  TFile output((Input.ReturnToken(0)+"/"+"wh2018_mtt.input.root").c_str(), "RECREATE");
