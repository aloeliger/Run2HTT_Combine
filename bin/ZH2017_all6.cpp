...
int main(int argc, char **argv)
{
  ...
  string theFileName = "zh2017.root";
  ...
  theShapeDebugger.cp().process({"ZH_lep_PTV_GT250_htt","ggZH_lep_PTV_GT250_htt","ZH_lep_PTV_GT250_hww125"}).AddSyst(cb,"ZH_scale_highpt", "shape", SystMap<>::init(1.00));
  ...
  //Scale met
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_scale_met_unclustered_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetAbsolute", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetAbsolute_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetBBEC1", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetBBEC1_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetEC2", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetEC2_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetFlavorQCD", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetHF", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetHF_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetRelativeSample_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JetRelativeBal", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb,"CMS_JER_2017", "shape", SystMap<>::init(1.00));

  //Scale mu, ele
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs})).bin({"eeet","eemt","eett","mmet"}).AddSyst(cb,"CMS_scale_e_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs})).bin({"eemt","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_m_etalt1p2_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs})).bin({"eemt","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_m_eta1p2to2p1_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs})).bin({"eemt","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_m_etagt2p1_2017", "shape", SystMap<>::init(1.00));

  // TES
  theShapeDebugger.cp().process({"ZZ","ZH_lep_htt","ZH_lep_PTV_0_75_htt","ZH_lep_PTV_75_150_htt","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_t_1prong_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"ZZ","ZH_lep_htt","ZH_lep_PTV_0_75_htt","ZH_lep_PTV_75_150_htt","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_t_1prong1pizero_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"ZZ","ZH_lep_htt","ZH_lep_PTV_0_75_htt","ZH_lep_PTV_75_150_htt","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_t_3prong_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process({"ZZ","ZH_lep_htt","ZH_lep_PTV_0_75_htt","ZH_lep_PTV_75_150_htt","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_scale_t_3prong1pizero_2017", "shape", SystMap<>::init(1.00));

  // Tau ID
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs,HWW})).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_tauideff_pt20to25_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs,HWW})).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_tauideff_pt25to30_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs,HWW})).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_tauideff_pt30to35_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs,HWW})).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_tauideff_pt35to40_2017", "shape", SystMap<>::init(1.00));
  theShapeDebugger.cp().process(JoinStr({{"Reducible","Triboson","ZZ"},sig_procs,HWW})).bin({"eeet","eemt","eett","mmet","mmmt","mmtt"}).AddSyst(cb,"CMS_tauideff_ptgt40_2017", "shape", SystMap<>::init(1.00));
